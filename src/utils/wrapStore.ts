...
interface StoreInterface {
    ...
    on: (event: StoreEvents, callback: (oldState: AppStateType, newState: AppStateType) => void) => void;
    off: (event: StoreEvents, callback: (oldState: AppStateType, newState: AppStateType) => void) => void;
}
